...
export default function ChapterContainer({ title, thumbnail, id, number }: { title: string, thumbnail: string, id: string, number: number, children?: React.ReactNode }) {
    ...
    return (
        <details
            ref={detailsRef}
            className="chapter-card border border-secondary font-heading text-5xl overflow-hidden [&:open>summary]:border-b bg-accent max-w-3xl mx-auto [&:open>summary>p>span]:rotate-90"
        >
            <summary
            ...
            >
                ...
                <p className="
                    p-8 text-tertiary text-[clamp(1.5rem,5vw,3rem)] w-full flex items-center
